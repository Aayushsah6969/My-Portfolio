...
// import {photo} from '../utils/IMG_9992.JPG';
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          <div className="flex-1 text-center lg:text-left">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-6 animate-fade-in">
              Hi, I'm <span className="text-indigo-600">Aayush Sah</span>
              <br />
            ...
            <div className="flex gap-4 justify-center lg:justify-start">
              <button className="bg-indigo-600 text-white px-8 py-3 rounded-lg hover:bg-indigo-700 transition-colors duration-300"  onClick={() => scrollToSection("contact")}>
                Hire Me
              </button>
